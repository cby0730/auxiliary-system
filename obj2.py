...
print('loading model...')
hub_model = hub.load("https://tfhub.dev/tensorflow/faster_rcnn/resnet101_v1_800x1333/1")
print('model loaded!')
...
def obj() :
  ...
  # all of them are explained in the documentation
    ...
    p = cv2.imread('output/output_pred.png_marked.png')
    cv2.imshow('', p)
    ...
    marking.drawAndSave( "%s_pred.png"%(sys.argv[1].split('.')[0]), "There is no taffic light" ) 
